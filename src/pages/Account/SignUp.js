...
const SignUp = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 bg-center bg-cover"
      style={{
        backgroundImage: `url('https://img.freepik.com/free-photo/keyboard-with-keys-house-model-white-background_23-2148182991.jpg')`,
      }}>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-.5">
                  ...
                  <input
                    onChange={handleName}
                    value={clientName}
                    className="w-full h-8 placeholder:text-sm placeholder:tracking-wide px-4 text-base font-medium placeholder:font-normal rounded-md border-[1px] border-gray-400 border-solid outline-none"
                    type="text"
